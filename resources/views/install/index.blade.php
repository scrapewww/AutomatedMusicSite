        ...
        <div class="col-md-4 col-md-push-4">
            <form method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="DB_HOST" id="DB_HOST" placeholder="DB Host" required>
                </div>
                <div class="form-group">
                    <label for="DB_PORT">DB Port</label>
                    <input type="text" class="form-control" name="DB_PORT" id="DB_PORT" placeholder="DB Port" required>
                </div>
                <div class="form-group">
